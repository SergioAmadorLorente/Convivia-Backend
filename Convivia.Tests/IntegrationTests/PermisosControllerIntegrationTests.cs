...
{
    /// <summary>
    /// Pruebas de integraci�n para PermisosController.
    /// Valida flujos CRUD completos, validaci�n de contenido real y casos de error.
    /// </summary>
    public class PermisosControllerIntegrationTests : IClassFixture<ConviviaWebApplicationFactory>, IAsyncLifetime
    {
        ...
        /// <summary>
        /// Limpieza despu�s de todos los tests de esta clase.
        ...
        /// <summary>
        /// Prueba crear un permiso con datos v�lidos.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Prueba crear m�ltiples permisos con diferentes roles.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Prueba obtener permiso por ID v�lido despu�s de crearlo.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Prueba obtener permisos por rol v�lido.
        /// </summary>
        [Fact]
        ...
        private PermisoDto ParsePermisoDto(string json)
        {
            using (var doc = JsonDocument.Parse(json))
            {
                ...
                var permiso = new PermisoDto
                {
                    ...
                    AnadirUsuario = FindBoolInElement(root, new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "a�adirUsuario", "A�adirUsuario", "anadirUsuario", "AnadirUsuario" }),
