...
{
    /// <summary>
    /// Controlador para la gesti�n de tareas dentro de espacios.
    ...
    public class TareaController : ControllerBase
    {
        ...
        /// <summary>
        /// Filtra tareas por d�a de la semana, estado y/o usuario asignado.
        /// </summary>
        /// <param name="espacioid">ID del espacio</param>
        /// <param name="diaSemana">D�a de la semana (0-6, opcional)</param>
        ...
        /// <summary>
        /// Obtiene las estad�sticas de tareas de un usuario en un espacio.
        /// Devuelve el n�mero de tareas completadas, pendientes y tard�as.
        /// </summary>
        /// <param name="espacioid">ID del espacio</param>
        /// <param name="usuarioId">ID del usuario</param>
        /// <param name="ct">Token de cancelaci�n</param>
        /// <returns>Estad�sticas de tareas del usuario</returns>
        /// <response code="200">Retorna las estad�sticas de tareas</response>
        ...
        public async Task<ActionResult<TareaEstadisticasDto>> GetEstadisticas(string espacioid, string usuarioId, CancellationToken ct = default)
        {
            ...
            catch (Exception ex)
            {
                ...
                { 
                    message = "Error interno al obtener estad�sticas de tareas", 
                    error = ex.Message 
                });
            }
        }
