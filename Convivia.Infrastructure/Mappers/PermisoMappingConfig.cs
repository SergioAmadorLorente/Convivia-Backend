        ...
        public void Register(TypeAdapterConfig config)
        {
            ...
            config.NewConfig<FireStorePermiso, Permiso>()
                ...
                .AfterMapping((src, dest) =>
                {
                    ...
                    dest.Rol.AñadirUsuario = src.AnadirUsuario;
            ...
            config.NewConfig<Permiso, FireStorePermiso>()
                ...
                .Map(dest => dest.AnadirUsuario, src => src.Rol != null && src.Rol.AñadirUsuario)
            ...
            config.NewConfig<UpdatePermisoDto, Permiso>()
                .AfterMapping((src, dest) =>
                {
                    ...
                    if (src.AnadirUsuario.HasValue) dest.Rol.AñadirUsuario = src.AnadirUsuario.Value;
